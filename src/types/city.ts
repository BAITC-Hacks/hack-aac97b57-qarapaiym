...
export interface Initiative { id: string; category: Category; name: string; description?: string; cost: number; scope: "district" | "city"; lag: number; effects: Partial<Record<Metric, number>>; }
